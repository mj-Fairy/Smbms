...
<div class="right">
        ...
        <div class="search">
        	<form method="post" action="${pageContext.request.contextPath }/sys/provider/providerlist.html">
				<span>供应商编码：</span>
				<input name="queryProCode" type="text" value="${newQueryCode}">
				
				<span>供应商名称：</span>
				<input name="queryProName" type="text" value="${newQueryProName}">
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${list}" varStatus="status">
				<tr>
					<td>
